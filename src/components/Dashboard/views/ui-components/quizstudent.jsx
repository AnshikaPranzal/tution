                                    ...
                                    <React.Fragment>
                                        <Row>
                                            <Col md={12} className="text-center">
                                                <div style={{marginLeft:"3em"}}>{x.hasImg &&  <ImageHelper id={x._id}></ImageHelper>}</div>
                                                <div style={{marginLeft:"3em"}}>{x.title}</div>
                                            </Col>
                                        </Row>
                                        ...
                                        <Row style={{marginTop:"3em"}}>
                                            {x.options.map((y,j)=>(
                                                ...
                                                <div>
                                                    <Input addon type="checkbox" onClick={()=>onCheckboxBtnClick(y._id)} aria-label="Checkbox for following text input" style={{marginTop:"4px"}} />
                                        ...
                                        <Row style={{marginTop:"3em"}}>
                                            ...
                                            <Col md={3} style={{marginRight:"0px",marginLeft:"auto"}} onClick={onSubmitandNext}><Button>Submit and Next</Button></Col>
