          ...
          <div className="row">
            ...
            <div className="col-lg-5">
              <p className="mb-5">
                ...
                earum fugiat, vel possimus commodi, deleniti et veniam, fuga
                ipsum praesentium. Odit unde optio nulla ipsum quae obcaecati!
                Quod esse natus quibusdam asperiores quam vel, tempore itaque
              ...
              <p>
                71 Shelton Street<br></br>London WC2H 9JQ England
              </p>
            </div>
          </div>
        </div>
